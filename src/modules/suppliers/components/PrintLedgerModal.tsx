    ...
    <div className="fixed inset-0 bg-black/60 z-[1000] flex justify-center items-center backdrop-blur-sm print:bg-white print:p-0 overflow-y-auto">
          ...
          <div id="ledger-print-area" className="bg-white p-8 shadow-sm mx-auto print:shadow-none min-h-[297mm] w-full max-w-[210mm] text-black font-sans">
            <div className="flex flex-col items-center border-b-2 border-black pb-4 mb-6 text-center">
                ...
                <div className="w-full flex justify-between items-center mt-4 pt-2 border-t border-dashed border-black">
                    <h2 className="text-xs font-black uppercase tracking-widest bg-black text-white px-3 py-0.5">Ledger Statement</h2>
      ...
      <style>{`
        @media print {
          ...
          #ledger-print-area { padding: 8mm 12mm !important; width: 100% !important; max-width: none !important; }
